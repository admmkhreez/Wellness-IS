        ...
        ?>
            ...
            <form action="insertRegister.php" id="register" method="post">
                ...
                <div>
                    ...
                    <input type="text" id="icpp" maxlength="14" placeholder="IC / Passport" name="icpp" required><span style="color: #7575a0; font-size: 14px; margin: 0px;"> *IC Format: 00000-00-0000. Include hyphen</span>
                </div>
                <div>
                ...
                <div class="textfield" style="margin-top: 10px;">
                    ...
                    <textarea type="text" id="addons" placeholder="*IF CUSTOM, MENTION THE PACKAGE CHOSEN" maxlength="100" name="addons" rows="4" cols="50"></textarea>
                </div>
                <br><br>
